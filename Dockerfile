...
COPY . .
    ...
    # Copy source files directly (skip TypeScript compilation for now)
    RUN mkdir -p dist && cp -r src/* dist/ && echo "Source files copied to dist/"# Install frontend dependencies
WORKDIR /app/client
